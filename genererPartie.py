...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Generates a random game of size S.')
	parser.add_argument('size', metavar='S', type=int, help='size of the game')
	...
	parser.add_argument('--numberByLine', type=int, metavar='nbl', dest='nbl', default=1, help='(unused)')
